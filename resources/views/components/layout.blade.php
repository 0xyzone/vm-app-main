...
<body class="w-screen h-screen relative font-light lg:font-normal z-0 smooth @if(Request::path() == "register") bg-gray-300 @elseif(Request::path() == "login") bg-gray-300 @else bg-gray-800 @endif" onload='display_ct7();'>
